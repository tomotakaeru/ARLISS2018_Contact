...
# Turn $GPGGA sentence into a Python dictionary.
...
with open("/home/pi/ARLISS/log/gps_log.txt", "a") as f:
    f.write("START\r\n")
...
#                firstFixDate = gpsData['fix_date'] + "-" + gpsData['fix_time']
            ...
            gps_log = gpsData['fix_time'][:-4] + "," + str(round(gpsData['decimal_latitude'], 7)) + "," + str(round(gpsData['decimal_longitude'], 7))
